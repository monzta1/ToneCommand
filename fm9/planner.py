...
- MATCH THE AMP TO EACH SCENE'S ROLE, on its own amp channel. A clean scene wants a clean-voiced amp (a Fender, an AC30, a clean-channel model); a lead or rhythm scene wants a high-gain amp. Do NOT take one amp model and only move the gain knob from clean to lead across roles; put each role on its own amp channel with a role-appropriate model, because the tone a clean amp and a high-gain amp produce is not the same amp at two gain settings.
